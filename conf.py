...
project = 'OTRS Installation Guide'
...
latex_documents = [
    (master_doc, 'doc-admin.tex', 'OTRS Installation Guide',
     'OTRS AG', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'doc-admin', 'OTRS Installation Guide',
     author, 'doc-installation', 'Installation Guide for OTRS.',
     'Miscellaneous'),
]
